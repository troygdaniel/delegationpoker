...
window.TestCases = function () {
  ...
  setTimeout(this.test1b,500);
  setTimeout(this.test2,1000);
  setTimeout(this.test3,1500);
  setTimeout(this.test4,2000);
  setTimeout(this.test5,2500);
  setTimeout(this.test6,3000);
  setTimeout(this.test7,3500);
  setTimeout(this.test8,4000);
  setTimeout(this.test9,4500);
  setTimeout(this.test10,5000);
  setTimeout(this.test11,5500);
  setTimeout(this.test12,6000);
  setTimeout(this.test13,6500);
  setTimeout(this.test14,7000);
...
window.TestCases.prototype.test1 = function () {
  ...
  TestCases.jiddu.register("testpass", function (json) {
    ...
    console.log(TestCases.jiddu_scenario);
  });
}
...
window.TestCases.prototype.test4 = function () {
  ...
  TestCases.bruce.signon("badpassword", function () {    
    ...
    // console.log(">> pass TEST4: Bruce fails to sign on");
  });
}
...
window.TestCases.prototype.test5 = function () {
  ...
  TestCases.bruce.signon("testpass", function (json) {    
    TestCases.bruce_vote1 = TestCases.bruce.vote(TestCases.jiddu_scenario, 3);
    // console.log(">> pass TEST5: Bruce succeeds to sign on and Bruce votes 3");
  }, function () {
...
window.TestCases.prototype.test10 = function () {
  TestCases.troy.signon("badpassword", function () {
    ...
    // console.log(">> pass TEST 10: Troy failed signon");
  });
}
...
window.TestCases.prototype.test13 = function () {
  ...
  x.get(TestCases.troy_scenario.id, function(doc) {
    if (doc && doc.error) {
      ...
      console.log(TestCases.troy_scenario.id);
